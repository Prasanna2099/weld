/* clarity-js v0.7.46: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
    ...
    function ai() {
        ei = null, Qr = null, $r.forEach((function(t) {
            t.called = !1
        }))
    }
    ...
    function ri(t, e, n) {
        ...
        var a = o.lean ? 0 : 1,
            r = !1;
        Qr && (a || !1 === e) && (t(Qr, !o.lean), r = !0), !n && r || $r.push({
            callback: t,
            wait: e,
            recall: n,
            called: r
            ...
            ! function(t) {
                if ($r.length > 0)
                    for (var e = 0; e < $r.length; e++) {
                        var n = $r[e];
                        !n.callback || n.called || n.wait && !t || (n.callback(Qr, !o.lean), n.called = !0, n.recall || ($r.splice(e, 1), e--))
                    }
